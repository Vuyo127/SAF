            ...
            ModalDrawerSheet {
                Column(modifier = Modifier.fillMaxSize().padding(16.dp)) {
                    ...
                    NavigationDrawerItem(
                        ...
                        selected = false,
                        onClick = {
                            navController.navigate("profile") // Profile has Reviews tab
                            scope.launch { drawerState.close() }
                        }
                    )
                    ...
                    NavigationDrawerItem(
                        ...
                        selected = false,
                        onClick = {
                            navController.navigate("profile") // Profile has Applications tab
                            scope.launch { drawerState.close() }
                        }
                    )
                    ...
                    NavigationDrawerItem(
                        ...
                        selected = false,
                        onClick = {
                            navController.navigate("profile") // Redirect to profile for now
                            scope.launch { drawerState.close() }
                        }
                    )
            ...
            Column(modifier = Modifier.padding(innerPadding).padding(16.dp)) {
                ...
                Row(
                    ...
                    AccommodationFilterChip(
                        label = "Price R500-R5000",
                        selected = isPriceFilterActive,
                        onClick = { isPriceFilterActive = !isPriceFilterActive }
                    )
                    AccommodationFilterChip(
                        label = "Single",
